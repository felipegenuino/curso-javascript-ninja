...
desafio.
*/
var teams = ['Chapecoense', 'Brusque', 'Avaí', 'Juventus-SC', 'Marcílio']
...
console.log( convertToHex('coral') ) // Não temos o equivalente hexadecimal para coral.
console.log( convertToHex('beige') ) // Não temos o equivalente hexadecimal para beige.
...
console.log( convertToHex('pink') ) // O hexadecimal para a cor pink é #FFC0CB.
console.log( convertToHex('turquoise') ) // O hexadecimal para a cor turquoise é #40e0d0.