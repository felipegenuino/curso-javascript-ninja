...
function calculator(operador){
  return function (a, b){ 
    ...
    return console.log(`Resultado da operação: ${a} ${operador} ${b} = ${result}.`) 
  };
}

console.log(calculator('%')(423,2))
/*
